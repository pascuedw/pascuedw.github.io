...
var addEvent = function(){
    $(".journalTextBoxes").append("<input class='removeNote note' type='text'>");
    
};

//add the code to remove the last input text box added. HINT: LOOK UP JQUERY .last() 
var removeEvent = function(){
    $(".removeNote").last().remove();
...
var addEntry = function(){
    ...
    $(".submit").click(function(){
        ...
        Journal = {events: tempArr, squirrel: squirrel};
